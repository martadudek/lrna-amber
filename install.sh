...
[[ -z `echo $AMBERHOME | grep -i "amber.*16"` ]] && echo "Error: this version works with AMBER 16 ONLY, Exiting." && exit 1

echo "Creating backup for $AMBERHOME/dat/leap/cmd/oldff/leaprc.ff14SB as $AMBERHOME/dat/leap/cmd/oldff/leaprc_BACKUP.ff14SB"
cp $AMBERHOME/dat/leap/cmd/oldff/leaprc.ff14SB $AMBERHOME/dat/leap/cmd/oldff/leaprc_BACKUP.ff14SB
...
echo "Overwriting $AMBERHOME/dat/leap/cmd/oldff/leaprc.ff14SB with L-RNA-friendly version" 
cp leaprc.ff14SB $AMBERHOME/dat/leap/cmd/oldff/leaprc.ff14SB
